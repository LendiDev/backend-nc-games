...
describe("pagination()", () => {
  test("should return an object with default offset and limit if not any params passed in", () => {
    const expected = { offset: 0, limit: 10 };
    expect(pagination()).toEqual(expected);
  });

	test("should return an object with default limit and offset calculated if only page passed in", () => {
    const expected = { offset: 10, limit: 10 };
    expect(pagination(2)).toEqual(expected);
  });

	test("should return an object with limit and offset calculated if page and limit passed in", () => {
    const expected = { offset: 5, limit: 5 };
    expect(pagination(2, 5)).toEqual(expected);
  });
	...
	test("should return an object with limit and offset calculated if page and limit passed in", () => {
    const expected = { offset: 20, limit: 5 };
    expect(pagination(5, 5)).toEqual(expected);
  });
});
